...
public class NongchanpinOrderVO implements Serializable {
    ...
    @TableField(value = "jiezhi_time_end")
    private Date jiezhiTimeEnd;
	 ...
	 * 设置：拼团结束时间
	 */
    public Date getJiezhiTimeEnd() {
        return jiezhiTimeEnd;
    }
    ...
    public void setJiezhiTimeEnd(Date jiezhiTimeEnd) {
        this.jiezhiTimeEnd = jiezhiTimeEnd;
    }
    /**
	 * 设置：实付价格
	 */
